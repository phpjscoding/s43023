<template>
  <header class="flex justify-center sm:justify-between items-center text-white p4">
    ...
    <NuxtLink :to="localePath('/')"
      class="mx-auto text-center dark:text-white text-black dark:hover:text-[#ff0000] hover:text-[#001EFA] no-underline">
      <!-- <UiIconspain-cars class="h-6 inline-block" :aria-label="t('a11y.logo')" /> -->
      <span class="text-4xl text-rose-700 ">Spain</span><span class="text-4xl text-yellow-500 text">Cars</span>
    </NuxtLink>
